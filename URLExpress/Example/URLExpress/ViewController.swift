...
//            }
        ...
        URL(domain: "https://alarrab.net", path: "api/profile/update")!
            ...
            .withAcceptType(.json)
            .decodeOnReceive(for: UpdateModel.self)
            .send {
                print($0)
            } success: {
                print($0)
